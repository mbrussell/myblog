---
title: What statistics students in natural resources want to learn more about
author: Matt Russell
date: '2021-12-22'
slug: []
categories:
...
```{r, echo = F, warning = F, message = F}
course <- read_csv("C://Users//russellm//Documents//Classes//UMN//NR 5021//Fall 2021//NR5021_courseinterest2020-2021.csv")
```

```{r, echo = F, warning = F, message = F}
ggplot(course, aes(x = reorder(Topic, NumInterested), y = NumInterested)) +
  geom_bar(stat = "identity") +
  labs(y = "Number of interested students",
       x = " ") +
  coord_flip() +
  theme_bw()
```
...
*As a part of the class, I've put together the book [Statistics in Natural Resources: Applications with R](https://stats4nr.com/). I welcome your feedback on it!*
