...
```{r, echo = F, warning = F, message = F, fig.cap = "Stumpage prices by Maine county, 2019 and 2020. NOE: Capital area includes Kennebec, Knox, Lincoln, and Waldo counties; Casco Bay includes Androscoggin, Cumberland, Sagadohoc, and York counties."}
...
Forest data analysts can use data like these to understand market conditions for different species. If you're interested in seeing the data set that contains these prices, I've made a spreadsheet [available on Github.]()
