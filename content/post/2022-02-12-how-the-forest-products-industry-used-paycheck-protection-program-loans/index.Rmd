---
title: How the forest products industry used Paycheck Protection Program loans (2022 update)
author: Matt Russell
date: '2022-02-12'
slug: []
categories:
...
mean_ppp_size %>% 
  kable("html", format.args = list(big.mark = ","),
        caption = 'Number and value of PPP loans provided to forest products companies.') %>%
  kable_styling()
```
